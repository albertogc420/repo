...
public class CustomerRest {
    ...
    public ResponseEntity<List<Customer>> listAllCustomers(@RequestParam(name = "regionId", required = false) Long regionId) {
        ...
        if (null == regionId) {
            ...
            Region region = new Region().builder().id(regionId).build();
    ...
    private String formatMessage(BindingResult result) {
        ...
        return processErrorMessage(errorMessage);
    }

    /**
     * processErrorMessage received
     * @param errorMessage
     * @return
     */
    private String processErrorMessage(ErrorMessage errorMessage) {
